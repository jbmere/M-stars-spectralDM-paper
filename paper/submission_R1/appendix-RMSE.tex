...
\caption {Average bias in the $T_{eff}$ (K) estimates computed (IRTF
  ...
  values in Table 3 of \protect\cite{cesetti}.}
\label{tab:irtf-teff-bias} 
% \end{center}
\end{table*}
...
\hline
\end{tabular}
\caption {RMSE and RMDSE for the various regression models that predict $T_{eff}$ (K) in 
          the Dwarf Archives wavelength range and resolution.} 
...
\caption {Performances of regression models trained on the features
  selected by \protect\cite{cesetti} and applied to BT-Settl spectra in the Dwarf Archives wavelength range and resolution.}
...
\caption {RMSE and RMDSE for the various regression models predicting $Log(G)$ [dex] 
          in the Dwarf Archives wavelength range and resolution.} 
