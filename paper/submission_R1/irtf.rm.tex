...
are to be prefered to the ones proposed by \cite{cesetti}.  \textbf{
...
\cite{cesetti}. Unfortunately, this is too small {\bf a number} to draw
...
PPR-ICA (clockwise, starting at the top left corner). {\bf These
