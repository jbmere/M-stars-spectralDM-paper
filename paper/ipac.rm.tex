...
{\bf rewrite with details } The relationship between the GA predicted
effective temperature and the one measured by Rojas-Ayala can be found
in the Figure~\ref{fig:ipac_lt_lt}
