...
{\bf TODO: discuss why the literature has smaller differences. Do they use higher resolution? IR spectra? IPAC is low res and optical, so we cannot do miracles, but this needs be explained.}
...
\begin{figure}
	...
	\end{center}
        ...
        \caption{Predictions of the GA-RF-$\infty$ regression model
