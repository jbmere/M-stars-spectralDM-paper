...
\begin{document} 
   ...
   \author{
          L. M. Sarro \inst{1}  
          \and
	  J. Ordieres-Mer\'e \inst{2}       
          \and
          A. Bello-Garc\'ia\inst{3} 
          \and
          A. Gonz\'alez-Marcos\inst{4} 
          \and
          E. Solano\inst{5}
          }

   \institute{ 
      \inst{} Universidad Nacional de Educaci\'{o}n a Distancia, \\
               Department of Artificial Intelligence.
               \email{lsb@uned.es}
        \and 
      \inst{} Universidad Polit\'{e}cnica de Madrid (UPM), ETSII. PMQ Research Group, \\
              Jos\'{e} Guti\'{e}rrez Abascal 2, 28006 Madrid, Spain. 
              \email{j.ordieres@upm.es}
        \and         
      \inst{}   Universidad de Oviedo, Construction and Manufacturing Engineering Department, \\
              Campus de Viesques s/n, Gij\'{o}n, Asturias, Spain. 
              \email{abello@uniovi.es} 
        \and 
      \inst{}  Universidad de la Rioja, P2ML Research Group, \\
              Luis de Ulloa 20, 26004 Logro\~{n}o, La Rioja, Spain. 
              \email{ana.gonzalez@unirioja.es}
         \and
      \inst{} Centro de Astrobiología (CSIC-INTA), \\
              Ctra. Ajalvir km 4, E-28850 Torrejón de Ardoz, Madrid, Spain.
              \email{esm@cab.inta-csic.es}
   }

   \date{Received \today; under review }
