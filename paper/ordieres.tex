...
\begin{document} 
   ...
   \institute{ 
      \inst{1}  Universidad Polit\'{e}cnica de Madrid (UPM), PMQ Research Group, \\
              Jos\'{e} Guti\'{e}rrez Abascal 2, 28006 Madrid, Spain. 
              \email{j.ordieres@upm.es}
        \and 
      \inst{2} Universidad Nacional de Educaci\'{o}n a Distancia, \\
      ...
      \inst{4}  Universidad de la Rioja, P2ML Research Group, \\
         ...
         \and
      \inst{5} Centro de Astrobiología (CSIC-INTA), \\
